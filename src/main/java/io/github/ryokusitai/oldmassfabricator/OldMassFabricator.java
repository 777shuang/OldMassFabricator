...
@Mod(
    ...
    name = OldMassFabricator.MODNAME,
    version = OldMassFabricator.VERSION,
    dependencies = "required-after:IC2;after:solidMatter")
public class OldMassFabricator {
    ...
    public static Item solidMatter = new Item().setUnlocalizedName("solidMatter")
        .setTextureName(MODID.toLowerCase() + ":uuMatter")
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        try {
            CreativeTabs tabIC2 = (CreativeTabs) Info.ic2ModInstance.getClass()
                .getField("tabIC2")
                .get(Info.ic2ModInstance);
        ...
        GameRegistry.addShapelessRecipe(
            new ItemStack(oldMassFabricator),
            new ItemStack(
